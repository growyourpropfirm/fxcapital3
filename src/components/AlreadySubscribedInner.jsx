...
export default function AlreadySubscribedInner() {
              ...
              <div className="relative z-10 text-center">
                ...
                {email && (
                  <p
                    ...
                    data-aos-delay="400"
                  >
                    The email <span className="font-medium text-white">{email}</span> is already on our list
                  </p>
                )}
                ...
                <div
                  ...
                  data-aos-delay="500"
                >
                  <p className="text-[#A0A8B0] mb-3">
                    You're already receiving our latest updates, trading insights, market analysis, and exclusive offers from FXCapital3.
                  </p>
                  <p className="text-sm text-[#88909C]">
                    If you're not receiving our emails, please check your spam folder or contact our support team.
                  </p>
                </div>
